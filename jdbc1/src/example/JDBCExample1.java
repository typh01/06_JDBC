...
public class JDBCExample1 {
	...
	public static void main(String[] args) {
		 ...
		 * 	- DB 서버 주소, 포트, DB 이름, 사용자명, 비밀번호
		 * 	- Connection 을 구현한 객체를 통해서
...
//			System.out.println(conn); // conn 객체 새성 확인
			
			/* 3. SQL 작성 
			 * 
			 * !! 주의 사항!!
			 * - JDBC 코드에서 SQL 작성 시
			 * 	 마지막에 세미콜론 작성 X <"문자열 내에 작성하지 말자">
			 * 	 -> 작성 시 : 
			...
			while(rs.next()) {
				...
				String locatioinId = rs.getString("LOCATION_ID");
				
				System.out.printf(
						"부서코드 : %s / 부서명 : %s / 지역코드 : %s \n",
						deptId, deptTitle, locatioinId);
			}
